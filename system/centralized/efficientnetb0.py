"""
Centralized training script for ISIC2019 using EfficientNetB0
...
def main():
    ...
    output_dir = os.path.join(script_dir, 'efficientnetb0_outputs')
    ...
    best_val_acc = 0
    best_epoch = 0
    best_model_path = os.path.join(output_dir, 'best_efficientnet_b0_isic2019.pth')
    ...
    print("\n=== Summary ===")
    print(f"Centralized EfficientNetB0 on ISIC2019:")
